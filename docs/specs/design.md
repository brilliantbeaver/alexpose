...
classDiagram
    ...
    IPoseEstimator <|-- YOLOv8PoseEstimator
    IPoseEstimator <|-- YOLOv11PoseEstimator
...
*For any* selected pose estimation framework (MediaPipe, OpenPose, YOLOv8 Pose, YOLOv11 Pose, AlphaPose), the system should return the correct number of keypoints in the expected format with confidence scores
...
**Validates: Requirements 2.6, 15.1, 15.2, 15.3**
