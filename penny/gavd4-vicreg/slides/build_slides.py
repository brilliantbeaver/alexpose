#!/usr/bin/env python3
"""Build and validate the GAVD3 PowerPoint and standalone HTML slides."""
...
SOURCE = SLIDE_DIR / "GAVD3_SJEPA_Gait_Tutorial.md"
HTML_OUTPUT = SLIDE_DIR / "GAVD3_SJEPA_Gait_Tutorial.html"
PPTX_OUTPUT = SLIDE_DIR / "GAVD3_SJEPA_Gait_Tutorial.pptx"
TEMPLATE = SLIDE_DIR / "html" / "template.html"
STYLESHEET = SLIDE_DIR / "html" / "slides.css"
RUNTIME = SLIDE_DIR / "html" / "slides.js"
EXPECTED_MAIN_SLIDES = 15
PPTX_THEME_REPLACEMENTS = {
    '<a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="Office Theme">':
        '<a:theme xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" name="GAVD3 S-JEPA Theme">',
...
def validate_sources() -> tuple[int, int, int]:
    required = [SOURCE, TEMPLATE, STYLESHEET, RUNTIME]
...
def validate_pptx(expected_slides: int) -> tuple[int, int]:
    ...
    with zipfile.ZipFile(PPTX_OUTPUT) as archive:
        ...
        if "GAVD3 S-JEPA Theme" not in theme or '<a:latin typeface="Arial"/>' not in theme:
            fail("The generated PowerPoint does not contain the expected GAVD3 theme.")
