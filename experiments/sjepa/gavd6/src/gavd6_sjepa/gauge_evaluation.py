...
from .amass_core11_jepa import TIME_PATCH_FRAMES
from .gait_parity_jepa import STANDARD_VARIANTS, load_checkpoint, parity_channels
from .gauge_training import GAUGE_ARMS
...
def evaluate(args: argparse.Namespace) -> pd.DataFrame:
    ...
    from .latent_laterality import calibrate_duration_temperature
