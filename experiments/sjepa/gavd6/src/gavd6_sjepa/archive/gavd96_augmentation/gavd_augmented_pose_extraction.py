...
from gavd6_sjepa.data_foundations.gavd_pose_extraction_primitives import (
    create_landmarker, detect_pose_in_crop, safe_literal, scaled_crop_bounds,
)

TUTORIAL_DIR = Path(__file__).resolve().parents[4]
...
def make_landmarker():
    return create_landmarker(POSE_MODEL_PATH, VIS_THRESHOLD)
