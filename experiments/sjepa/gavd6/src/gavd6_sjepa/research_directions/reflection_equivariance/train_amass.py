...
from .jepa import AMASS_VARIANTS, VICRegProjector, build_model, trainable_parameter_count
from gavd6_sjepa.shared_infrastructure.artifact_io import atomic_write_json as write_json
