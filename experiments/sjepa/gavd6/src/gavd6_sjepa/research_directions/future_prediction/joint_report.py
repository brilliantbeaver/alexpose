...
from .cache_reuse import checked_file, load_reused_cache, verify_reused_readiness
from .joint_training import verify_joint_fold
from .metrics import score_arrays, source_bootstrap_counts, source_error_sums, score_source_sums
from .decisions import decide_direct_gate
...
def verify_numerics(root, *, require_report=True):
    ...
    """
    from .reporting import assemble_oof
    root = Path(root)
