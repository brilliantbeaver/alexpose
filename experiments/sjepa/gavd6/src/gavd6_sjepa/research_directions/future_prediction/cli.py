...
def init_main():
    ...
    args = parsed(parser)
    from .contracts import VJEPA_COMMIT, initialize_run
    ...
    from .contracts import write_once_json
...
def cohort_main():
    ...
    from .cohort import build_candidates
    from .contracts import check_run, stage_lock

    if check_run(args.run_root).get("protocol") == "direct-v3":
        from .cache_reuse import load_reused_cache
...
def poses_main():
    ...
    from .cohort import extract_and_freeze
    from .contracts import stage_lock
...
def cache_main():
    ...
    configure_threads()
    from .contracts import stage_lock
    from .feature_cache import cache_teacher, load_cache
    from .vjepa import FrozenVJEPAAdapter
...
def audits_main():
    ...
    configure_threads()
    from .contracts import stage_lock, audit_summary_path, protocol_name, check_run, DIRECT_PROTOCOL
    from .validity_audits import ValidityAuditRejected, require_audits, run_audits
    from .vjepa import FrozenVJEPAAdapter
...
def fit_main():
    ...
    configure_threads()
    from .contracts import stage_lock
    from .nested_training import fit_outer_fold
...
def score_main():
    ...
    from .contracts import stage_lock
    from .reporting import score_gate
...
def report_main():
    ...
    from .contracts import stage_lock, write_json
...
def init_cached_main():
    ...
    args = parsed(parser)
    from .contracts import stage_lock
    from .cache_reuse import initialize_cached_run
...
def calibrate_main():
    ...
    args = parser.parse_args()
    from .joint_calibration import calibrate
...
def verify_main():
    ...
    args = parsed(parser)
    from .joint_report import verify_numerics
