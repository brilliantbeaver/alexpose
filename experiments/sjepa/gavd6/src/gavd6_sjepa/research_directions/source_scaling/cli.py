...
from ..future_prediction.contracts import stage_lock, read_json, write_json
from .cohort import freeze, read_study
...
def main(argv=None):
    ...
    if command=='freeze':
        ...
        from .learning_curve import report
        result=report(root,parent,verify=True)
    else:
        from . import data as data, learning_curve as training
