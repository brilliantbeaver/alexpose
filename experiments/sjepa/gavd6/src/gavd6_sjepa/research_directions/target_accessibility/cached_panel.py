...
from ..future_prediction.cache_reuse import verify_reused_readiness
...
from ..future_prediction.feature_cache import load_cache
from ..future_prediction.joint_models import (
    JointModelContract,
    JointRidge,
    SupportedInput,
    fit_joint_baseline,
...
from ..future_prediction.joint_training import (
    nested_partition,
    predict_selected,
    choose_candidate,
    summarize,
...
from ..future_prediction.metrics import (
    score_arrays,
    source_error_sums,
    source_bootstrap_counts,
    score_source_sums,
)
from ..future_prediction.nested_training import isolated_split, partition_control
from ...shared_infrastructure.artifact_io import atomic_save_joblib, atomic_write_dataframe_csv
...
def implementation_identity():
    ...
    cli = Path(__file__).resolve().parents[4] / "scripts/research_directions/target_accessibility/run_cached_panel.py"
    return {"code_layout": "study-v2", "future_innovation_sha256": code_fingerprint(),
