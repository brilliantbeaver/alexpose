...
from gavd6_sjepa.research_directions.reflection_equivariance.amass_training import TIME_PATCH_FRAMES
from gavd6_sjepa.research_directions.reflection_equivariance.jepa import (
    STANDARD_VARIANTS,
    load_checkpoint,
    parity_channels,
)
from .training import GAUGE_ARMS
...
from .protocol import require_benchmark_gate
...
def evaluate(args: argparse.Namespace) -> pd.DataFrame:
    ...
    from .inference import calibrate_duration_temperature
