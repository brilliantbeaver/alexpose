...
Run: uv run python scripts/notebook_builders/idea09/build_amass_training.py
...
def find_notebook_root(start=None):
    ...
    for candidate in dict.fromkeys(candidates):
        if (candidate / "src" / "gavd6_sjepa" / "train_amass.py").is_file():
            return candidate
...
from gavd6_sjepa.train_amass import main
