...
[`build_notebooks.py`](build_notebooks.py).
Their scientific operations remain in `src/gavd6_sjepa/research_directions/future_prediction/`.
...
```bash
.venv/bin/python scripts/research_directions/future_prediction/build_notebooks.py --only 00 01 02 03 04
.venv/bin/python scripts/research_directions/future_prediction/build_notebooks.py --check
.venv/bin/python scripts/research_directions/future_prediction/verify_notebooks.py
```

The verifier and HAIC jobs share `execute_notebook.py`, which
...
and the [notebook HAIC jobs](../../../slurm/future-prediction/notebooks/README.md) for the
...
[notebook execution validation](../../../slurm/future-prediction/validation.md#notebook-execution-path--2026-09-10):
...
The [validation record](../../../slurm/future-prediction/validation.md#direct-v2-50-clip-gate--2026-09-11)
