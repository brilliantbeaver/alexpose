...
from build_notebooks import NAMES, ROOT
...
def verify_pipeline_smoke(output, protocol):
    ...
    from gavd6_sjepa.research_directions.future_prediction.smoke import synthetic_cache, synthetic_audit
    ...
    if protocol == "legacy-v1":
        ...
        import pandas as pd
        from gavd6_sjepa.research_directions.future_prediction.contracts import read_json, write_json, sha256_file
