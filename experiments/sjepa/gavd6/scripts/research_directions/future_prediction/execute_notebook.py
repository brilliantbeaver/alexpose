...
from build_notebooks import DESTINATION, NAMES, ROOT, render

sys.path.insert(0, str(ROOT / "src"))
from gavd6_sjepa.research_directions.future_prediction.contracts import stage_lock
from gavd6_sjepa.research_directions.future_prediction.notebook_workflow import OUTCOME_MIME
...
def execute_notebook(number, *, mode="teach", run_root=None, outer_fold=None,
    ...
    with stage_lock(lock_root, f"notebook-{lock_id}"):
        ...
        record["orchestration_sha256"] = {
            ...
            (Path(__file__), Path(__file__).with_name("build_notebooks.py"),
             ROOT / "src/gavd6_sjepa/research_directions/future_prediction/notebook_workflow.py")}
