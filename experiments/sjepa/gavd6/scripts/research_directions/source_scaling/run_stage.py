...
def main():
    ...
    if args.stage == 'initialize':
        ...
        command = [sys.executable, str(ROOT / 'scripts/research_directions/source_scaling/initialize.py'), 'initialize']
    else:
        command = [sys.executable, str(ROOT / 'scripts/research_directions/source_scaling/run.py'),
