...
DESTINATION = ROOT / "notebooks/source_scaling/23_source_learning_curves.ipynb"
def render():
...
and [execution guide](../../slurm/source-scaling/README.md). New runs use the
...
Use `bash slurm/source-scaling/submit.sh status` with the same
