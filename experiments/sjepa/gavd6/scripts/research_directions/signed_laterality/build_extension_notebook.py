"""Build the Idea 05 futures-and-reach notebook.

Run: uv run python scripts/research_directions/signed_laterality/build_extension_notebook.py
...
NB_PATH = ROOT / "notebooks" / "signed_laterality" / "02_futures_and_reach.ipynb"
...
out = BUNDLE_DIR / "idea5_futures_bundle.json"
try:
