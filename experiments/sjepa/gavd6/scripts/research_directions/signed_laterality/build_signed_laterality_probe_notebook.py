"""Build the Idea 05 signed-laterality probe notebook.

Run: uv run python scripts/research_directions/signed_laterality/build_signed_laterality_probe_notebook.py
The builder is the authoritative source for the generated notebook.
"""
import json
from pathlib import Path

ROOT = Path(__file__).resolve().parents[3]
NB_PATH = ROOT / "notebooks" / "experiments" / "idea05_signed_laterality" / "01_probe.ipynb"
