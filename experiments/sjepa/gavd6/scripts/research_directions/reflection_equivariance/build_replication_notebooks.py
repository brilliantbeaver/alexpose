...
Run: uv run python scripts/research_directions/reflection_equivariance/build_replication_notebooks.py
...
from gavd6_sjepa.research_directions.reflection_equivariance.jepa import load_gavd_records
