...
Run: uv run python scripts/research_directions/reflection_equivariance/build_extension_notebook.py
...
NB_PATH = ROOT / "notebooks" / "reflection_equivariance" / "02_futures_and_reach.ipynb"
