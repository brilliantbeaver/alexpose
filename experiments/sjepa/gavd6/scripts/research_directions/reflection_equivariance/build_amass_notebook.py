...
Run: uv run python scripts/research_directions/reflection_equivariance/build_amass_notebook.py
...
NOTEBOOK = ROOT / "notebooks" / "reflection_equivariance" / "08_amass_training.ipynb"
...
def find_notebook_root(start=None):
    ...
    for candidate in dict.fromkeys(candidates):
        if (candidate / "src" / "gavd6_sjepa" / "research_directions"
                / "reflection_equivariance" / "train_amass.py").is_file():
            return candidate
