...
Run: uv run python scripts/research_directions/reflection_equivariance/build_encoder_notebook.py
...
NB_PATH = ROOT / "notebooks" / "reflection_equivariance" / "01_encoder_contract.ipynb"
