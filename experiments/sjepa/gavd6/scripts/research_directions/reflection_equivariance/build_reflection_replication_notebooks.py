...
Run: uv run python scripts/research_directions/reflection_equivariance/build_reflection_replication_notebooks.py
...
from gavd6_sjepa.research_directions.reflection_equivariance.jepa_model_architecture import load_gavd_records
