...
Run: uv run python scripts/research_directions/reflection_equivariance/build_gavd_notebooks.py
"""
...
ROOT = HERE.parents[2]
NOTEBOOK_DIR = ROOT / "notebooks" / "reflection_equivariance"
...
def find_notebook_root(start=None):
    ...
    for candidate in dict.fromkeys(candidates):
        if ((candidate / "src" / "gavd6_sjepa" / "research_directions"
             / "reflection_equivariance" / "jepa.py").is_file()
                and (candidate / "notebooks" / "reflection_equivariance"
...
outputs = {
    NOTEBOOK_DIR / "03_gavd_contract.ipynb": cells_09c,
    NOTEBOOK_DIR / "04_gavd_training.ipynb": cells_09d,
    NOTEBOOK_DIR / "05_gavd_audit.ipynb": cells_09e,
}
