...
OUTPUT_DIR = ROOT / 'notebooks/target_accessibility'
...
def figure(name):
    return code(f"display(SVG(filename=str(ROOT / 'docs/studies/future-feature-prediction/manuscript/figures/{name}.svg')))")
...
def evidence_notebook():
    ...
    **By the end:** you will be able to explain the laterality readout decline,
    ...
    [the tutorial](../../docs/studies/future-feature-prediction/accessibility/tutorial.md).
    ''')]
...
def symmetry_notebook():
    ...
    '''), code('''
    from gavd6_sjepa.research_directions.target_accessibility.symmetry import run_calibration
...
def distillation_notebook():
    ...
    '''), code('''
    from gavd6_sjepa.research_directions.target_accessibility.symmetry import paired_teacher_components
...
def main():
    ...
    notebooks={
        '19_evidence':evidence_notebook,
        '20_temporal_information':symmetry_notebook,
        '21_target_accessibility':panel_notebook,
        '22_distillation_design':distillation_notebook,
    }
