...
OUT = ROOT / 'docs/studies/future-feature-prediction/accessibility/evidence'
...
def main():
    ...
    (OUT / 'README.md').write_text(
        ...
        'Regenerate with `.venv/bin/python scripts/research_directions/target_accessibility/build_evidence.py`.\n')
