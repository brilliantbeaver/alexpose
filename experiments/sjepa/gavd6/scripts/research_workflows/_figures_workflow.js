...
- No em-dashes anywhere (use commas, periods, or parentheses). Every number consistent with
  ${RESEARCH_DIR}/_shared_facts.md. Folder labels are dataset annotations, not diagnoses; all current results transductive.
`
...
Read the file in full. Also read ${DESIGN} and ${RESEARCH_DIR}/_shared_facts.md.
...
TASK: Refresh ${RESEARCH_DIR}/images/00_portfolio_hub.svg so it presents ALL TWELVE proposals grouped by FOUR themes,
replacing the current seven-item / three-theme version. Read the current 00_portfolio_hub.svg first (keep its
title voice and overall composition), read ${RESEARCH_DIR}/README.md for the authoritative 12-row grouping, the four
