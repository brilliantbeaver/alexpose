# Three-week GAVD6 research portfolio
...
| 4 | 03: Readout-aligned collapse audit | Do token-level health metrics hide low sequence-level effective rank after pooling? | High for audit, medium for remedy | A repository bug report alone is not significant | Mechanism study |
...
| 6 | 07: Selective invariance stress test | Is the representation stable to camera-like transforms while remaining sensitive to anatomical left-right changes? | Medium-high | Synthetic transforms are not real camera viewpoints | Stretch mechanism |
...
- ICML 2026 selected papers partly for longevity beyond a narrow subcommunity. A GAVD6 result must therefore produce a reusable evaluation lesson for small, grouped skeleton datasets. See the [official ICML awards process](https://blog.icml.cc/2026/07/05/announcing-the-icml-2026-awards/).
