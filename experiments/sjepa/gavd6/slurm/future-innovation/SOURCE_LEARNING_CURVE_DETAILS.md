...
The bundle's [provenance](../future-innovation-scaling/launch/known-exposure.json)
...
[`notebooks/future_innovation/23_source_learning_curves.ipynb`](../../notebooks/future_innovation/23_source_learning_curves.ipynb).
The launcher modes `all`, `compute`, `fit` and `report` append CPU job
`launch/24-notebooks.sbatch` after their production jobs. Its `afterany`
...
[notebook 23](../../notebooks/future_innovation/23_source_learning_curves.ipynb). For a completed report, check
