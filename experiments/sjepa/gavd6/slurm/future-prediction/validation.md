...
and [independent review/dispositions](../../docs/studies/future-feature-prediction/gate/execution-history.md#direct-v2-50-clip-gate--11-september-2026).
...
The [investigation](../../docs/studies/future-feature-prediction/gate/execution-history.md#run-haic-gojuxseb-verified-audit-rejection)
...
directory. See the [investigation and adversarial review](../../docs/studies/future-feature-prediction/gate/execution-history.md)
...
The separate [notebook jobs](notebooks/README.md) execute the same CLI stages as the
...
scientific hypothesis. See the [study overview](../../docs/studies/future-feature-prediction)
