...
numeric statements below as historical context. No em-dashes.
...
## Condition-specific HIGH-priority mechanisms (historically sourced)
...
## Data reality that bounds any clinical claim (from evidence constraints)
...
- Frozen checkpoint fingerprint d0acc262.
...
- Plus the citations that were formerly listed in the retired evidence-constraints fact sheet.
