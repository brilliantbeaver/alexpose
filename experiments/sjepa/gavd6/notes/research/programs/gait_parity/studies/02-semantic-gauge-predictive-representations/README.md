# Study 02: semantic-gauge predictive representations
...
1. [Idea 05](../../../../ideas/05-signed-laterality-decodability/) probed a frozen
...
2. [Idea 09](../../../../ideas/09-reflection-equivariant-symmetry-axis/) built a
...
Study 02 addresses a different inference problem. The action $P^{g_k}$ is a
...
The [proposal](./proposal.md) gives the exact audit.

## Documents

- [proposal.md](./proposal.md) is the general-audience scientific case. It
...
- [theory.md](./theory.md) gives the typed transformation model, the corrected
  ...
  technical glossary.
- [practical.md](./practical.md) is the two-week runbook. It maps data and code,
