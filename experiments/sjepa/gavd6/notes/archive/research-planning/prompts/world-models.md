...
Ultrathink on creatively analyzing the above work and thoughtfully produce a groundbreaking research idea that can be highly novel and inlfuential in a similar scale to those projects. You should build on the work that I have already done in this repo, either directly or indirectly.
