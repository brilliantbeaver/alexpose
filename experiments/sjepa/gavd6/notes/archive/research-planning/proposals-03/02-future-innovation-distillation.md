...
For the complete setup, data contracts, code scaffolds, controls, metrics, artifact layout, and stop/advance logic, follow the [Experiment 0 guide](../../../../docs/studies/future-feature-prediction/gate/design.md).
