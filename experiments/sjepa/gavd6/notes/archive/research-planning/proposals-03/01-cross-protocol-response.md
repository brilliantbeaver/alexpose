...
See the [expanded study protocol](../../../../docs/studies/perturbation-response/protocol/overview.md) for the complete abstract, introduction, methodology, and experimental plan.
