...
The executed run record is `outputs/repaired-jepa-seed7-v2/summary.csv`. It reports 7,326 seconds, or 2.04 hours, for 100 epochs. The launcher `slurm/reflection-equivariance/train-amass.sbatch` requests one H100. No distributed launcher appears in that job. Candidate estimates therefore use the more conservative user anchor:
