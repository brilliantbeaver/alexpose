...
| [Repository laterality proposal](../../../../docs/studies/latent-laterality/protocol/proposal.md) | Already defines even and odd channels and tests a correspondence mechanism | The executed probability mechanism was matched by fixed 50/50 uncertainty. Proposal 6 is a deliberately weaker unsigned error assay. |
