...
The joined GaitParity program that once accompanied proposals 05 and 09 has
been superseded by the current [Fixed-reflection baseline
contract](../../../docs/studies/fixed-reflection-baselines/) and [Latent
Laterality study](../../../docs/studies/latent-laterality/). The original
proposals remain below as archival reference, not as an execution queue.
...
## Relation to retired planning material

The former `plan/` portfolio is not included in this checkout. This archive is
therefore retained only as an exploratory menu, while active execution guidance
lives in the current study documentation linked above.
