...
no duplicate/malformed arrowheads, no off-palette hue, no em-dash, numbers consistent with ${RESEARCH_DIR}/_shared_facts.md,
...
full, plus ${DESIGN} and ${RESEARCH_DIR}/_shared_facts.md. Inspect at the COORDINATE level: estimate text bounding boxes
