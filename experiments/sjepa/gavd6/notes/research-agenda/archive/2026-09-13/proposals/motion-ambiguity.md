...
![Two admissible motions match the same observation and disagree on one measured movement property](../figures/motion-ambiguity-mechanism.svg)
...
![Constructed ambiguity gives a known test; extra evidence checks whether the competing explanation is rejected](../figures/motion-ambiguity-experiment.svg)
