...
![A short walk supplies memory for a different activity](../figures/cross-activity-prediction-mechanism.svg)
...
![Correct memory must beat matched alternative explanations](../figures/cross-activity-prediction-experiment.svg)
