...
![The teacher sees a branch cue that the student does not](../figures/probabilistic-forecasting-mechanism.svg)
...
![First establish real distributional information, then test transfer](../figures/probabilistic-forecasting-experiment.svg)
