...
**Historical review.** The constraint-conflict candidate was replaced by [motion beyond keypoints](../proposals/motion-beyond-joints.md). Its rank and candidate number below refer to the earlier portfolio.

Reviewed the full [archived constraint proposal](../proposals/conflicting-motion-requests.md) and [common evidence and execution contract](../../../references/experiment-guidelines.md). Changes were restricted to that proposal and this review log. This is a research-design review, not a proof implementation or an experiment result.
