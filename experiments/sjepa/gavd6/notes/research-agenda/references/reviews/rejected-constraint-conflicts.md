...
![Three possible outputs: checked motion, checked conflict, or unknown](archive/07-constraints-mechanism.svg)
...
![Establish nontrivial certified cases before testing whether learned search helps](archive/07-constraints-experiment.svg)
