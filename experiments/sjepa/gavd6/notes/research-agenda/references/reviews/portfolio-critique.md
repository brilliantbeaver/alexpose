...
**Historical selection review, before the optical-flow request.** The final [ranking](../../README.md) replaces the former constraint candidate with [P7: motion beyond keypoints](../../proposals/motion-beyond-keypoints.md). This memo preserves the earlier decision and objections; it is not the final recommendation.
