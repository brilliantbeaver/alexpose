"""latent laterality / test benchmark."""
...
from gavd6_sjepa.research_directions.latent_laterality.manifest import (
    build as build_amass_gauge_manifest,
)
from gavd6_sjepa.research_directions.latent_laterality.protocol import (
    ARM_SPECS,
    require_benchmark_gate,
    source_screen_jobs,
)
from gavd6_sjepa.research_directions.latent_laterality.training import semantic_gauge_objective
