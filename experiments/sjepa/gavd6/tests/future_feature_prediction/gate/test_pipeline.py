"""future feature prediction / gate / test pipeline."""
...
from gavd6_sjepa.research_directions.future_prediction.contracts import initialize_run, read_json
from gavd6_sjepa.research_directions.future_prediction.feature_cache import (
    cache_teacher,
    load_cache,
)
...
from gavd6_sjepa.research_directions.future_prediction.video_pose import normalize_skeleton
...
class FutureInnovationDataFlowTests(unittest.TestCase):
    ...
    def _data_flow(self, protocol, box_pattern):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "gavd6_sjepa.research_directions.future_prediction.cohort.extract_history",
            ...
            with patch.object(
                ...
                "gavd6_sjepa.research_directions.future_prediction.feature_cache.fixed_projection",
            ...
            if protocol == "legacy-v1":
                ...
                from gavd6_sjepa.research_directions.future_prediction.readiness import run_readiness
