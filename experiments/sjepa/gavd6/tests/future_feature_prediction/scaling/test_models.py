"""future feature prediction / scaling / test models."""
...
from gavd6_sjepa.research_directions.future_prediction.joint_calibration import fixture
from gavd6_sjepa.research_directions.future_prediction.joint_models import (
    JointModelContract,
    JointRidge,
    baseline_schema,
)
from gavd6_sjepa.research_directions.source_scaling.cohort import (
    POLICY,
    make_plan,
    reserve_sources,
    source_groups,
)
from gavd6_sjepa.research_directions.source_scaling.data import (
    seal,
    verify_data_identity,
    verify_prepared_inputs,
    verify_seal,
)
from gavd6_sjepa.research_directions.source_scaling.learning_curve import (
    compute_curve,
    prediction_payload,
    report,
    run,
...
from gavd6_sjepa.research_directions.source_scaling.nested_selection import nested_partition
...
class ScalingPlanTests(unittest.TestCase):
    ...
    def test_historical_gate_still_rejects_expansion(self):
        from gavd6_sjepa.research_directions.future_prediction.cohort import select_eligible
...
class ScalingNumericsTests(unittest.TestCase):
    def test_unscaled_orchestration_matches_historical_implementation(self):
        from gavd6_sjepa.research_directions.future_prediction.joint_training import nested_partition as historical
    ...
    def test_actual_fit_reload_reuse_and_rehashed_prediction_rejection(self):
        ...
        with tempfile.TemporaryDirectory() as tmp,threadpool_limits(1):
            ...
            module='gavd6_sjepa.research_directions.source_scaling.learning_curve.'
