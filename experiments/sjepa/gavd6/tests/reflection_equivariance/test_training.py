"""reflection equivariance / test training."""
...
from gavd6_sjepa.research_directions.reflection_equivariance.train_amass import (
...
class AmassCore11JepaTests(unittest.TestCase):
    ...
    def test_completed_epoch_history_survives_later_interruption(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch(
                "gavd6_sjepa.research_directions.reflection_equivariance.amass_training.evaluate_variant",
