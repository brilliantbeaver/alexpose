"""infrastructure / test compatibility."""
...
from gavd6_sjepa.data_foundations import amass_conversion as amass_core11_conversion_pipeline
from gavd6_sjepa.research_directions.latent_laterality import (
    inference as laterality_corruption_inference,
)
from gavd6_sjepa.research_directions.reflection_equivariance import (
    amass_training as amass_core11_training_pipeline,
    jepa as jepa_model_architecture,
)
...
class ArchivedCompatibilityPathTests(unittest.TestCase):
    ...
    def test_old_converter_script_exports_new_implementation(self) -> None:
        self.assertIs(
            ...
            __import__(
                "gavd6_sjepa.data_foundations.amass_conversion",
