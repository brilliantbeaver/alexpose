...
> **Historical manuscript.** This paper records the pre-repair five-stage
> GAVD experiment. It is retained for provenance and must not be used as the
> current execution protocol or evidence summary; see the [current study
> index](../../studies/).
