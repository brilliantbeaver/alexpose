...
> contract. Start with the [study index](../) for current evidence and
> next actions. The [Future Innovation tutorial](../future-feature-prediction/)
...
> [Latent Laterality](../latent-laterality/results/validation.md) completed
...
> [docs/history/urtc-2026/](../../history/urtc-2026/).
...
![End-to-end method](../../history/urtc-2026/figures/pipeline.svg)
...
![Cohort and curriculum](../../history/urtc-2026/figures/cohort_curriculum.svg)
...
![Training health](../../history/urtc-2026/figures/training_health.svg)
...
![Canonical representation geometry](../../history/urtc-2026/figures/representation_geometry.svg)
...
![Readout results](../../history/urtc-2026/figures/readout_results.svg)
...
|---|---|
|[`foundations/00`](../../../notebooks/gait_classification/00_sjepa_basics.ipynb)|A small S-JEPA learning graph built from first principles|
|[`foundations/01`](../../../notebooks/gait_classification/01_gavd_data.ipynb)|A traceable manifest and one cached copy of each source video|
|[`foundations/02`](../../../notebooks/gait_classification/02_pose_extraction.ipynb)|Versioned 33-landmark pose sequences and alignment checks|
|[`foundations/03`](../../../notebooks/gait_classification/03_keypoint_masking.ipynb)|The whitelist parser, uniform sampler, and forbidden-target assertions|
|[`foundations/04`](../../../notebooks/gait_classification/04_staged_training.ipynb)|The complete five-stage checkpoint lineage and training history|
|[`foundations/05`](../../../notebooks/gait_classification/05_representation_analysis.ipynb)|Prediction, collapse, drift, retrieval, and condition-geometry audits|
|[`foundations/06`](../../../notebooks/gait_classification/06_gait_classifiers.ipynb)|Three leakage-aware readout lanes and missingness controls|
|[`idea09/01`](../../../notebooks/reflection_equivariance/01_encoder_contract.ipynb)|The reflection-equivariant encoder contract and smoke-mode matched comparison|
|[`idea09/02`](../../../notebooks/reflection_equivariance/02_futures_and_reach.ipynb)|Pre-registered futures, decision tables, and non-clinical reach scaffolds|
|[`idea09/03`](../../../notebooks/reflection_equivariance/03_gavd_contract.ipynb)|The frozen full-GAVD cohort, objective, health gates, and matching ledger|
|[`idea09/04`](../../../notebooks/reflection_equivariance/04_gavd_training.ipynb)|Fresh paired-seed standard, paired-unconstrained, and reflection-equivariant JEPA training|
|[`idea09/05`](../../../notebooks/reflection_equivariance/05_gavd_audit.ipynb)|Checkpoint health and reflection-geometry audits for the matched GAVD run|
|[`idea09/06`](../../../notebooks/reflection_equivariance/06_cpu_replication.ipynb)|Opt-in, three-seed full-96 CPU replication under exposure and compute matching|
|[`idea09/07`](../../../notebooks/reflection_equivariance/07_gpu_replication.ipynb)|Opt-in, three-seed full-96 CUDA replication under exposure and compute matching|
...
- [Latent Laterality study](../latent-laterality/)
- [Fixed-reflection baseline contract](../reflection-equivariance/)
- [Historical staged paper](../../history/urtc-2026/staged_sjepa_gait.md)
- [Historical long tutorial](../../history/urtc-2026/staged_details.md)
- [Historical methodology evolution tutorial](../../history/urtc-2026/staged_evolution.md)
- [S-JEPA class and tensor-flow guide](../../tutorials/sjepa_model_internals.md)
