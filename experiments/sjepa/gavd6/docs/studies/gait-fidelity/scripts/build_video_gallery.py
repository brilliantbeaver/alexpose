...
<h1>Gait Fidelity: inspect the local footage</h1><p><a href="local-videos.md">Audit and interpretation</a> · <a href="../methods/masking.md">Inherited masking protocol</a> · <a href="../images/gallery.html">Conceptual figures</a></p>
<p class="notice">Deferred development collection: these videos do not enter the active JEPA response follow-up. <a href="../README.md">Read the current study</a> for the prepared AMASS inputs and supported claims.</p>
