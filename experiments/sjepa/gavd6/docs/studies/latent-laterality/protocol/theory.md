...
![The four representational layers and the location of the latent convention](../development/images/theory-01-representation-layers.svg)
...
![Two latent worlds produce one observation, while an anchor breaks the global ambiguity](../development/images/theory-02-identifiability-and-anchor.svg)
...
![A dependency map from linear algebra and probability to the study's models and estimands](../development/images/theory-03-learning-path.svg)
