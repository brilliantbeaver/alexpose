...
![A simple explanation of the label-drift problem](figures/study-so-far-01-label-drift.svg)
...
![How paired views eliminate an arbitrary-label shortcut](figures/study-so-far-02-paired-views.svg)

![How independent gaps remove the boundary shortcut](figures/study-so-far-03-independent-gaps.svg)
...
For the detailed protocol and implementation, see the [working proposal](../protocol/proposal.md) and [HAIC run guide](../execution/haic.md).
