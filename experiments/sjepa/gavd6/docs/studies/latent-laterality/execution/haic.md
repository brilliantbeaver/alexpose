...
this plan. Read the [completed findings](../results/validation.md#current-conclusion-and-next-decision).
...
```bash
cd "$GAVD6_ROOT"
j13=$(sbatch --parsable --export=ALL slurm/latent-laterality/paired-amass/train-development.sbatch)
...
j14=$(sbatch --parsable --export=ALL --dependency="afterok:$j13" \
  slurm/latent-laterality/paired-amass/evaluate-development.sbatch)
...
```bash
j15=$(sbatch --parsable --export=ALL slurm/latent-laterality/paired-amass/train-confirmation.sbatch)
...
j16=$(sbatch --parsable --export=ALL --dependency="afterok:$j15" \
  slurm/latent-laterality/paired-amass/evaluate-final.sbatch)
...
```bash
cd "$GAVD6_ROOT"
j1=$(sbatch --parsable --export=ALL slurm/latent-laterality/legacy/convert-amass.sbatch)
j2=$(sbatch --parsable --export=ALL --dependency="afterok:$j1" slurm/latent-laterality/legacy/prepare-amass.sbatch)
j3=$(sbatch --parsable --export=ALL --dependency="afterok:$j2" slurm/latent-laterality/legacy/benchmark-amass.sbatch)
...
j4=$(sbatch --parsable --export=ALL slurm/latent-laterality/source-transfer/prepare-gavd.sbatch)
j5=$(sbatch --parsable --export=ALL --dependency="afterok:$j4" slurm/latent-laterality/source-transfer/screen.sbatch)
j6=$(sbatch --parsable --export=ALL --dependency="afterok:$j5" slurm/latent-laterality/source-transfer/evaluate.sbatch)
...
```bash
j7=$(sbatch --parsable --export=ALL slurm/latent-laterality/source-transfer/prepare-selected.sbatch)
j8=$(sbatch --parsable --export=ALL --dependency="afterok:$j7" slurm/latent-laterality/source-transfer/benchmark.sbatch)
...
```bash
j9=$(sbatch --parsable --export=ALL slurm/latent-laterality/legacy/train-development.sbatch)
...
```bash
j10=$(sbatch --parsable --export=ALL slurm/latent-laterality/legacy/train-confirmation.sbatch)
