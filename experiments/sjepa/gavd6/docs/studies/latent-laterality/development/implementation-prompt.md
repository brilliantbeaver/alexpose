...
> [completed findings and next decision](../results/validation.md#current-conclusion-and-next-decision).
...
- `docs/studies/latent-laterality/protocol/theory.md`
- `docs/studies/latent-laterality/protocol/experiments.md`
- `docs/studies/latent-laterality/results/swap-probe.md`
- `docs/studies/reflection-equivariance/protocol/fixed-reflection.md`
- `docs/studies/reflection-equivariance/results/gavd-probe.md`
