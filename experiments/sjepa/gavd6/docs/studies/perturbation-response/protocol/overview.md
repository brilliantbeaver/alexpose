...
This document expands [Proposal 01](../../../../notes/archive/research-planning/proposals-03/01-cross-protocol-response.md) into a standalone study plan. All model choices, thresholds, splits, and claims described below are prospective.
...
For an implementation-oriented walkthrough, see the [Experiment 0 availability and harmonization guide](data-harmonization.md).
