...
Run the expensive hashing once, write it atomically, and reuse it. The repository already provides atomic CSV and JSON writers in `shared_infrastructure/artifact_io.py`.
