...
- [Protocol and implementation status](protocol/fixed-reflection.md)
- [Current evidence](results/reflection.md)
- [Novelty and interpretation limits](results/limitations.md)
