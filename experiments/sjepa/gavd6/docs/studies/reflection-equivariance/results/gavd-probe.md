# Frozen lower-body representation probe on GAVD

**Artifact:** `work/artifacts/gavd_core11_frozen_probe/`
**Code:** `uv run gavd6 gavd evaluate-core11` and
`src/gavd6_sjepa/research_directions/reflection_equivariance/gavd_probe.py`
...
On the strict 90-frame, no-short-clip-padding cohort, the raw 11-landmark lower-body representation baseline
