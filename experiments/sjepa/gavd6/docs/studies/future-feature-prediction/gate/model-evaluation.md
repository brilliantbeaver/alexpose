...
in the [initial investigation](model-diagnostics.md).
...
.venv/bin/python scripts/research_directions/future_prediction/evaluate_failures.py \
  --run-root outputs/future-innovation \
...
- [Evaluation implementation](../../../../scripts/research_directions/future_prediction/evaluate_failures.py)
- [Regression checks](../../../../tests/future_feature_prediction/gate/test_diagnostics.py)
