...
supplied and evaluated. Read the [saved-model evaluation](model-evaluation.md)
...
[the head implementation](../../../../src/gavd6_sjepa/research_directions/future_prediction/residual_models.py).
...
```bash
.venv/bin/python scripts/research_directions/future_prediction/probe_residual_head.py \
...
See [residual construction and selection](../../../../src/gavd6_sjepa/research_directions/future_prediction/nested_training.py).
...
```bash
.venv/bin/python scripts/research_directions/future_prediction/inspect_fits.py \
...
The [original distillation proposal](../../../../notes/archive/research-planning/proposals-03/02-future-innovation-distillation.md)
remains design context. The [frozen direct-v2 protocol](../../future-innovation/direct-gate-protocol.md)
