...
[the HAIC guide](../../../../slurm/future-prediction/notebooks/README.md).
...
[the validation record](../../../../slurm/future-prediction/validation.md).
...
.venv/bin/python scripts/research_directions/future_prediction/verify_notebooks.py --pipeline-smoke
```
...
[VALIDATION.md](../../../../slurm/future-prediction/validation.md).
...
The [current specification](../../future-innovation/direct-gate-protocol.md) is the authoritative design
...
[VALIDATION.md](../../../../slurm/future-prediction/validation.md). Local generated
