...
The [joint-model module](../../../../src/gavd6_sjepa/research_directions/future_prediction/joint_models.py)
contains scaling, temporal summaries and the solve. The
[nested fitting module](../../../../src/gavd6_sjepa/research_directions/future_prediction/joint_training.py)
contains source isolation, candidate selection, typed reload and training-statistic
verification. [Cache inheritance](../../../../src/gavd6_sjepa/research_directions/future_prediction/cache_reuse.py)
and [numerical reporting](../../../../src/gavd6_sjepa/research_directions/future_prediction/joint_report.py)
...
The [fixed calibration implementation](../../../../src/gavd6_sjepa/research_directions/future_prediction/joint_calibration.py)
...
| `gavd6 ... calibrate-repair --output .../calibration-final.json`, through `.venv/bin/python -m gavd6_sjepa.cli` | All frozen exact/statistical calibration checks passed; [log](../../../../work/artifacts/future-innovation-repair-2026-09-11/calibration-final.log) |
...
The [execution guide](../../../../slurm/future-prediction/README.md#calibrated-cached-development-repair-direct-v3)
gives complete copyable local and HAIC commands, exact output locations, and
resumption behavior. [Notebook execution](../../../../slurm/future-prediction/notebooks/README.md#cached-direct-v3-notebooks)
