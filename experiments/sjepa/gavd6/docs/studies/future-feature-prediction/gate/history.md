...
**Current development extension:** the [source learning curve](../../future-innovation/source-learning-curve-protocol.md)
tests whether more training recordings help the [completed direct-v3 repair](results.md).
Its [audit and validation record](../scaling/implementation.md) distinguishes
the frozen confirmation reservation from the expanded real-data fit, which is
blocked on input/HAIC access. See the [execution guide](../../../../slurm/source-scaling/README.md).
...
[current protocol and decision rules](../../future-innovation/direct-gate-protocol.md).
...
cached development comparison. Read the [saved-model evaluation and revised plan](model-evaluation.md)
for the real-data interventions, verified evidence and conditional distillation
steps. The [initial synthetic investigation](model-diagnostics.md)
...
[investigation and independent review](execution-history.md).
...
Use the [HAIC run guide](../../../../slurm/future-prediction/README.md) for input
setup, then the [separate notebook launchers](../../../../slurm/future-prediction/notebooks/README.md):

```bash
bash slurm/future-prediction/submit-notebooks.sh all
```
...
The [direct gate specification](../../future-innovation/direct-gate-protocol.md) defines the current
comparison. The [original guide](design.md)
...
The [notebook maintenance and verification guide](../../../../scripts/research_directions/future_prediction/README.md)
documents selective regeneration, fresh-kernel checks and measured runtimes.

## Calibrated direct-v3 development repair

The [repair and validation report](results.md) records the
...
The [frozen repair protocol](../../future-innovation/direct-v3-repair-protocol.md) specifies safe input
