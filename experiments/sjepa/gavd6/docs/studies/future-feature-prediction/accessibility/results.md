...
![Paired uncertainty in the new cached comparison.](../manuscript/figures/06_cached_panel_results.svg)
...
```python
from gavd6_sjepa.research_directions.target_accessibility.verification import verify_panel_supplement
...
```bash
.venv/bin/python scripts/research_directions/target_accessibility/build_notebooks.py
...
.venv/bin/python scripts/research_directions/target_accessibility/check_deliverables.py --output work/artifacts/iclr-bridge-2026-09-11/deliverable-audit.json
```
...
The current [notebook guide](../../../../notebooks/target_accessibility/README.md)
...
`notebooks/target_accessibility/`, including notebook 21's default numerical
...
```bash
MPLCONFIGDIR=/tmp/iclr-mpl .venv/bin/python scripts/research_directions/target_accessibility/build_figures.py
.venv/bin/python scripts/research_directions/target_accessibility/build_manuscripts.py --compile
.venv/bin/python scripts/research_directions/target_accessibility/build_evidence.py
```
