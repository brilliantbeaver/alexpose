# Student-accessible future features
...
- [Historical overview](history.md): the earlier research-bridge narrative.
- [Notebook guide](../../../../notebooks/target_accessibility/README.md): four inspection and synthetic-explanation notebooks.

Preserve JSON report content and the frozen protocol. Source paths inside evidence manifests record provenance and are not mutable navigation links.
