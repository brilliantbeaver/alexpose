...
|---|---|
| [19 — Evidence and observability](../../../../notebooks/target_accessibility/19_evidence.ipynb) | Which claims are measured, which are algebraic, and which still need experiments. |
| [20 — Symmetry and temporal information](../../../../notebooks/target_accessibility/20_temporal_information.ipynb) | Why reflection, temporal order and prediction are distinct properties. |
| [21 — Student-accessible future features](../../../../notebooks/target_accessibility/21_target_accessibility.ipynb) | How to inspect the separately fitted cached accessibility comparison. |
| [22 — Selective future distillation](../../../../notebooks/target_accessibility/22_distillation_design.ipynb) | How to calibrate target selection and design the subsequent student study. |
...
![Inputs, targets and the evaluation boundary.](../manuscript/figures/02_information_boundary.svg)
...
![Reflection and reversing time change different properties.](../manuscript/figures/03_reflection_and_time.svg)
...
.venv/bin/python scripts/research_directions/target_accessibility/run_cached_panel.py verify \
  --output-root outputs/iclr-bridge-cached-20260911
```
...
![A staged workflow from evidence to independent confirmation.](../manuscript/figures/04_research_workflow.svg)
...
![Matched current posture with different incoming motion and futures.](../manuscript/figures/05_matched_pose_futures.svg)
