...
The evidence review and temporary reproduction are also retained in [the laterality audit directory](../../../../work/artifacts/iclr-bridge-2026-09-11/laterality). Focused tests and the 125-test future-innovation regression suite are documented in [the validation report](results.md). The review is an additional challenge to the evidence; it does not replace future experimental confirmation or author responsibility for the final submission.
