...
const ITEMS = [
  ...
  },
  {
    ...
    lift: `Promote from "does one structured mask beat uniform on gavd5-draft" to the MASK-FAMILY-AT-EQUAL-COVERAGE
  ...
  },
  {
    ...
    lift: `Viewpoint-conditioned predictor with view_delta as an "action" (V-JEPA-2 action-conditioning framing,
      ...
      gavd5-draft is monocular YouTube with no controlled multi-view data, so the CORE invariance arm runs on public
      multi-view POSE cohorts (CASIA-B Yu 2006; OU-MVLP-Pose Takemura 2018; GREW arXiv:2205.02692; Gait3D
      arXiv:2204.02569), all NON-clinical, with gavd5-draft view-labels only as a secondary probe; the clinical claim
...
- The generalizable-claim restatement (what transfers beyond gavd5-draft: the method/principle).
...
- overclaim_flags: HARD flag any clinical-accuracy claim on gavd5-draft (n=18 sources) that is not explicitly hedged as
...
- generalizability_verdict: does the result transfer beyond gavd5-draft (a method/principle), or is it only a gavd5-draft caveat?
