...
**The internal work (the real study).** The gavd5-draft GAVD cohort (Ranjan et al., IEEE Access 2025,
...
- **Monocular capture.** gavd5-draft is single-view video, so nothing here speaks to multi-view robustness.
