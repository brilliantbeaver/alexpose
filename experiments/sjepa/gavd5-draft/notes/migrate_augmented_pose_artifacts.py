...
``gavd5-draft/cache/artifacts/real`` even when notebook 04 was configured to read a
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="legacy real-mode artifact root (default: gavd5-draft/cache/artifacts/real)",
    )
    parser.add_argument(
