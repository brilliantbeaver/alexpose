...
Emits the notebook in the gavd5 root beside nb_05a. Pure numpy/sklearn/matplotlib: no torch,
...
Notebook 05a runs the single decisive probe on the frozen `ea59fea0` checkpoint and emits one verdict.
