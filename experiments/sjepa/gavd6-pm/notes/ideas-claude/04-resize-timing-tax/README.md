...
- Optionally overlay, as labeled context bound to checkpoint `ea59fea0`, how the pooled model behaves on resized input, clearly marked as non-primary.
