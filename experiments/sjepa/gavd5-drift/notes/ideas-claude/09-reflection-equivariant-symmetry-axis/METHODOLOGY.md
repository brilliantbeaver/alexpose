...
The core work uses the gavd5-drift GAVD cohort (Ranjan et al., IEEE Access 2025, DOI
...
- Monocular capture. gavd5-drift is single-view, so the view-stability and genuine-mirror questions can
