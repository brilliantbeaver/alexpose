...
Internal work (the real study): the gavd5-drift GAVD cohort (Ranjan et al., IEEE Access 2025,
...
conservative conclusion stands: any clinical reading stays reach-tier and is never claimed from the 18 gavd5-drift videos.
...
- Monocular capture. gavd5-drift is single-view, so out-of-plane motion and transverse rotation are not seen.
