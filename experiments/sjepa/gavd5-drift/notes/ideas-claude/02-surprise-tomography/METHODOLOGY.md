...
### Internal work: the gavd5-drift GAVD cohort
...
- Monocular capture. gavd5-drift is single-view BlazePose (x, y, and a relative z), so out-of-plane motion and true depth are weak, and the cross-view and genuine-mirror questions belong to the external multi-view cohorts, not here.
- Skeleton limits. Skeletons cannot recover kinetics or propulsion (force plates), EMG, spasticity or coactivation, transverse-plane rotation, or an etiologic muscle diagnosis. No clinical-accuracy claim is made on gavd5-drift at any outcome.
