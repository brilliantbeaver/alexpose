...
- Monocular capture. gavd5-drift is single-view, so the view-stability and genuine-mirror questions can only be answered on the
...
- Skeleton limits. Skeletons cannot recover forces, muscle-electrical activity, spasticity, out-of-plane rotation, or a
  muscle diagnosis, so no clinical-accuracy claim is made on gavd5-drift at any outcome.
