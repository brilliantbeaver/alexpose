...
2. **External multi-view reach scaffold.** The clinical claim on gavd5-drift (n=18 source videos) is
...
The clinical claim on gavd5-drift is internal-validity only: n=18 canonical source videos, transductive
...
bundle = {
    ...
    "notes": "Simulated expected shapes, NOT data. gavd5-drift clinical claim is internal-validity only.",
}
