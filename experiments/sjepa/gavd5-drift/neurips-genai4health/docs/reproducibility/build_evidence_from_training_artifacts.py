"""Historical checkpoint-backed evidence builder; requires the original full training artifacts.

Use build_evidence.py for current retained-output verification. Running this script
recalculates the older figures and tables; it is not part of the default build.
"""
