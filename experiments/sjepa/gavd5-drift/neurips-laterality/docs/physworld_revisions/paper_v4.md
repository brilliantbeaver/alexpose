...
Anonymous working manuscript · Revision 4 · 9 September 2026
...
| Batch with mask | \(B\times528\times96\), plus target indices and validity | Gathering and padding retain each clip's own targets; paired arms match counts per clip, which may vary across the batch. |
